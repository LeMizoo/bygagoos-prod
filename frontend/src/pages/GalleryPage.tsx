...
// Données enrichies avec les designs malgaches
...
// Nouveaux designs inspirés de Madagascar
...
export default function GalleryPage() {
  ...
  const collectionOptions = useMemo(() => {
    return ["Tous", ...Array.from(new Set(designs.filter(d => d.collection).map(d => d.collection)))];
  }, []);

  const ethnicGroupOptions = useMemo(() => {
    return ["Tous", ...Array.from(new Set(designs.filter(d => d.ethnicGroup).map(d => d.ethnicGroup!)))];
  }, []);
  ...
  const filteredDesigns = useMemo(() => {
    ...
    if (selectedCollection !== "Tous") {
      filtered = filtered.filter(
        (design) => design.collection === selectedCollection
      );
    }
    ...
    if (selectedEthnicGroup !== "Tous") {
      filtered = filtered.filter(
        (design) => design.ethnicGroup === selectedEthnicGroup
      );
    }
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {/* Logo Vagues d'Émeraude à gauche */}
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {collectionOptions.map((collection) => (
                          <button
                            key={collection}
                            onClick={() => setSelectedCollection(collection || "Tous")}
                            className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${
...
// Composant DesignCard enrichi - Version Prestige
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-white">
        ...
        {/* Badge collection en haut à droite */}
        {design.collection && (
...
// Composant DesignListItem enrichi - Version Prestige
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex-1 p-6">
          ...
          <div className="flex flex-wrap gap-4 mb-4">
            ...
            {design.tags && design.tags.map((tag, i) => (
...
// Composant Inspiration Section - Version Prestige
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600 text-sm">
            Inspiré des tissages traditionnels des hauts-plateaux et des imprimés vifs des côtes
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-600 text-sm">
            Motifs inspirés de l'océan Indien et des pirogues traditionnelles
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-600 text-sm">
            Baobabs, ravinala et plantes uniques de Madagascar
          </p>
        </motion.div>
      </div>
      
      <div className="mt-10 text-center">
        <div className="inline-block bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full border border-amber-200">
          <p className="text-sm text-gray-600 italic">
            "Nos créations sont une fusion unique entre l'art textile traditionnel malgache et le design contemporain."
          </p>
        </div>
      </div>
    </motion.section>
...
// Composant EmptyState - Version Prestige
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-500 mb-8 max-w-md mx-auto">
        Aucun design ne correspond à vos critères de recherche. Essayez de modifier vos filtres.
      </p>
      <button
        onClick={onReset}
        className="px-8 py-4 bg-gradient-to-r from-amber-600 to-amber-500 text-white rounded-xl hover:from-amber-700 hover:to-amber-600 transition-all font-medium shadow-lg hover:shadow-xl"
      >
...
// Composant CategoriesSection - Version Prestige
...
// Composant StudioPhotosSection - Version Prestige
...
// Composant CTASection - Version Prestige
function CTASection() {
  return (
    <motion.section
      initial={{ opacity: 0, y: 30 }}
      ...
      <div className="relative text-center text-white max-w-4xl mx-auto px-4">
        ...
        >
          <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full border border-white/30">
            <Heart className="h-4 w-4" />
            <span className="text-sm">Création sur mesure</span>
            <Heart className="h-4 w-4" />
          </div>
        </motion.div>
        ...
        <p className="text-lg md:text-xl mb-8 text-amber-100 max-w-2xl mx-auto">
          Discutons de votre projet et créons ensemble une pièce unique qui
          reflète votre identité et l'âme de Madagascar
        </p>
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          href="/contact"
          className="inline-flex items-center px-10 py-5 bg-white text-amber-700 rounded-xl hover:bg-gray-100 font-semibold transition-all shadow-xl hover:shadow-2xl group"
        >
